...
func New(opts Options) *fiber.App {
	...
	app.Post("/v1/sheets/:id/archive", func(c *fiber.Ctx) error { return setStatus(opts, c, "archived") })
	app.Post("/v1/sheets/:id/restore", func(c *fiber.Ctx) error { return setStatus(opts, c, "active") })
	app.Delete("/v1/sheets/:id", func(c *fiber.Ctx) error { return setStatus(opts, c, "deleted") })
